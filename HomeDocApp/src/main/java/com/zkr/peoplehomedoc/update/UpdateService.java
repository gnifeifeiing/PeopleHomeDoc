package com.zkr.peoplehomedoc.update;
...
/**
 * @Description:        apk下载service
 * @author               LF
 * @date                 2016/4/28 11:11
 */  
...
//		Log.e("updateAPK","update  service");
//		filePath=intent.getStringExtra("filepath");
//		fileName=intent.getStringExtra("filename");
//		nm = (NotificationManager) getSystemService(NOTIFICATION_SERVICE);
//		notification = new Notification();
//		notification.flags = Notification.FLAG_AUTO_CANCEL;
//		notification.icon = intent.getIntExtra("appicon", R.mipmap.ic_launcher);
//		notification.tickerText =intent.getStringExtra("appname") + "更新";
...
//
//		// 下载
//		downFile(intent.getStringExtra("download"));
