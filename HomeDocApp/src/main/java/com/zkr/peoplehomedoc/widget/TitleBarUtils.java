...
public class TitleBarUtils extends RelativeLayout {
	...
	public TitleBarUtils(Context context, AttributeSet attrs) {
		...
		title = arr.getString(R.styleable.TitleBarLayout_titleBarText);
		titleTextColor = arr.getColor(
				R.styleable.TitleBarLayout_titleBarTextColor, Color.WHITE);
		titleTextSize = arr.getDimension(
				R.styleable.TitleBarLayout_titleBarTextSize, 20.0f);
		leftImage = arr.getDrawable(R.styleable.TitleBarLayout_leftImage);
		leftImage = context.getResources().getDrawable(R.mipmap.title_bar_backup);
		rightImageOne = arr
